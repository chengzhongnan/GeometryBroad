...
const helpMessages = new Map<string, string>([
    ...
    ['TANGENT', 'TANGENT: 过一点作圆的切线, 并创建切点.\n- 必须参数: name, circle (或c), point (或p, 圆外或圆上的点).\n- name 是**切点的名字**, 逗号分隔多个.\n- 点在圆外: 两条切线, 两个切点 -> name=T1,T2; 切线自动命名为 T1_tan / T2_tan. 只给一个名字时第二个切点自动取名 <名字>_2.\n- 点在圆上: 一条切线, 切点即给定点 -> name=T1; 切线自动命名为 T1_tan.\n- 点若已经落在某个切点位置上, 直接复用该点, 不重复创建.\n- 可选参数: draw.\n- 示例: CREATE TANGENT name=T1,T2 circle=c1 point=P draw=true.'],
